...
module bd_f60c
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.CLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLK, ASSOCIATED_BUSIF SLOT_0_AXI:SLOT_1_AXI, ASSOCIATED_RESET resetn, CLK_DOMAIN design_1_zynq_ultra_ps_e_0_0_pl_clk0, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) input clk;
  input [0:0]probe0;
  ...
  bd_f60c_ila_lib_0 ila_lib
       (.clk(clk_1),
        ...
        .probe33(net_slot_1_axi_arburst),
        .probe34(net_slot_1_axi_arcache),
        .probe35(net_slot_1_axi_arid),
        ...
        .probe40(net_slot_1_axi_arsize),
        .probe41(net_slot_1_axi_aruser),
        ...
        .probe61(net_slot_1_axi_ruser),
        .probe62(net_slot_1_axi_wdata),
        .probe63(net_slot_1_axi_wstrb),
        .probe64(net_slot_1_axi_wuser),
