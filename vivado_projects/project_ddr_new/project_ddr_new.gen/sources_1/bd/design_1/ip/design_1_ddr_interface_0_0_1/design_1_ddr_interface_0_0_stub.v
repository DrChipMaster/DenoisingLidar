...
module design_1_ddr_interface_0_0(o_write_address, o_write_payload, 
  ...
  i_start, i_pointcloud_size, i_filtertype, i_finish_read, o_finish, clock)
/* synthesis syn_black_box black_box_pad_pin="o_write_address[31:0],o_write_payload[63:0],o_readAdress[31:0],o_initwritetxn,o_initreadtxn,i_AMU_P[6399:0],rst,i_write_TxnDone,i_read_TxnDone,i_start,i_pointcloud_size[31:0],i_filtertype[3:0],i_finish_read[15:0],o_finish[15:0],clock" */;
  output [31:0]o_write_address;
  output [63:0]o_write_payload;
  output [31:0]o_readAdress;
  output o_initwritetxn;
  output o_initreadtxn;
  input [6399:0]i_AMU_P;
  input rst;
