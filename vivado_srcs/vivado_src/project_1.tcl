...
#
# Generated by Vivado on Sun Sep 26 20:16:41 +0100 2021
...
#
#    "H:/Vivado_projects/project_1/project_1.srcs/test_module.v"
#    "H:/Vivado_projects/project_1/project_1.srcs/constrs_1/new/constrains.xdc"
#
# 3. The following remote source files that were added to the original project:-
#
#    "H:/GitHub/ALFA/ALFA-P/MU/memoryInterface.v"
#
#*****************************************************************************************
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/../../project_1.srcs/test_module.v"]"\
 "[file normalize "$origin_dir/../../project_1.srcs/constrs_1/new/constrains.xdc"]"\
  ]
  foreach ifile $files {
  ...
  set files [list \
 "[file normalize "$origin_dir/../../../../GitHub/ALFA/ALFA-P/MU/memoryInterface.v"]"\
  ]
  foreach ifile $files {
    if { ![file isfile $ifile] } {
...
set file "$origin_dir/../../../../GitHub/ALFA/ALFA-P/MU/memoryInterface.v"
...
set file "project_1.srcs/test_module.v"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
set_property -name "is_global_include" -value "0" -objects $file_obj
...
set file "[file normalize "$origin_dir/../../project_1.srcs/constrs_1/new/constrains.xdc"]"
...
set_property -name "target_constrs_file" -value "[get_files *new/constrains.xdc]" -objects $obj
set_property -name "target_ucf" -value "[get_files *new/constrains.xdc]" -objects $obj
...
if { [get_files memoryInterface.v] == "" } {
  import_files -quiet -fileset sources_1 H:/GitHub/ALFA/ALFA-P/MU/memoryInterface.v
}
if { [get_files test_module.v] == "" } {
  import_files -quiet -fileset sources_1 H:/Vivado_projects/project_1/project_1.srcs/test_module.v
}
...
# module references:
# MI_memoryInterface_AXI, test_module
  ...
  set o_led2 [ create_bd_port -dir O o_led2 ]
  set o_led3 [ create_bd_port -dir O o_led3 ]
  set o_led4 [ create_bd_port -dir O o_led4 ]
  ...
  # Create instance: test_module_0, and set properties
  set block_name test_module
  set block_cell_name test_module_0
  if { [catch {set test_module_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $test_module_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
...
connect_bd_intf_net -intf_net [get_bd_intf_nets MI_memoryInterface_A_0_M_AXI] [get_bd_intf_pins MI_memoryInterface_A_0/M_AXI] [get_bd_intf_pins system_ila_0/SLOT_0_AXI]
  ...
  connect_bd_net -net MI_memoryInterface_A_0_o_AMU_P0 [get_bd_pins MI_memoryInterface_A_0/o_AMU_P0] [get_bd_pins system_ila_0/probe0] [get_bd_pins test_module_0/i_AMU_P0]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets MI_memoryInterface_A_0_o_AMU_P0]
  connect_bd_net -net MI_memoryInterface_A_0_o_AMU_P1 [get_bd_pins MI_memoryInterface_A_0/o_AMU_P1] [get_bd_pins test_module_0/i_AMU_P1]
  connect_bd_net -net MI_memoryInterface_A_0_o_AMU_P2 [get_bd_pins MI_memoryInterface_A_0/o_AMU_P2] [get_bd_pins test_module_0/i_AMU_P2]
  connect_bd_net -net MI_memoryInterface_A_0_o_AMU_P3 [get_bd_pins MI_memoryInterface_A_0/o_AMU_P3] [get_bd_pins test_module_0/i_AMU_P3]
  connect_bd_net -net MI_memoryInterface_A_0_o_AMU_P4 [get_bd_pins MI_memoryInterface_A_0/o_AMU_P4] [get_bd_pins system_ila_0/probe6] [get_bd_pins test_module_0/i_AMU_P4]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets MI_memoryInterface_A_0_o_AMU_P4]
  connect_bd_net -net MI_memoryInterface_A_0_o_AMU_P5 [get_bd_pins MI_memoryInterface_A_0/o_AMU_P5] [get_bd_pins test_module_0/i_AMU_P5]
  connect_bd_net -net MI_memoryInterface_A_0_o_AMU_P6 [get_bd_pins MI_memoryInterface_A_0/o_AMU_P6] [get_bd_pins test_module_0/i_AMU_P6]
  connect_bd_net -net MI_memoryInterface_A_0_o_AMU_P7 [get_bd_pins MI_memoryInterface_A_0/o_AMU_P7] [get_bd_pins test_module_0/i_AMU_P7]
  connect_bd_net -net MI_memoryInterface_A_0_o_AMU_P8 [get_bd_pins MI_memoryInterface_A_0/o_AMU_P8] [get_bd_pins system_ila_0/probe7] [get_bd_pins test_module_0/i_AMU_P8]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets MI_memoryInterface_A_0_o_AMU_P8]
  connect_bd_net -net MI_memoryInterface_A_0_o_AMU_P9 [get_bd_pins MI_memoryInterface_A_0/o_AMU_P9] [get_bd_pins test_module_0/i_AMU_P9]
  connect_bd_net -net MI_memoryInterface_A_0_o_AMU_P10 [get_bd_pins MI_memoryInterface_A_0/o_AMU_P10] [get_bd_pins test_module_0/i_AMU_P10]
  connect_bd_net -net MI_memoryInterface_A_0_o_AMU_P11 [get_bd_pins MI_memoryInterface_A_0/o_AMU_P11] [get_bd_pins test_module_0/i_AMU_P11]
  connect_bd_net -net MI_memoryInterface_A_0_o_AMU_P12 [get_bd_pins MI_memoryInterface_A_0/o_AMU_P12] [get_bd_pins test_module_0/i_AMU_P12]
  connect_bd_net -net MI_memoryInterface_A_0_o_AMU_P13 [get_bd_pins MI_memoryInterface_A_0/o_AMU_P13] [get_bd_pins test_module_0/i_AMU_P13]
  connect_bd_net -net MI_memoryInterface_A_0_o_AMU_P14 [get_bd_pins MI_memoryInterface_A_0/o_AMU_P14] [get_bd_pins test_module_0/i_AMU_P14]
  connect_bd_net -net MI_memoryInterface_A_0_o_MI_readTxnDone [get_bd_pins MI_memoryInterface_A_0/o_MI_readTxnDone] [get_bd_pins system_ila_0/probe3] [get_bd_pins test_module_0/i_read_TxnDone]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets MI_memoryInterface_A_0_o_MI_readTxnDone]
  connect_bd_net -net MI_memoryInterface_A_0_o_MI_writeTxnDone [get_bd_pins MI_memoryInterface_A_0/o_MI_writeTxnDone] [get_bd_pins test_module_0/i_write_TxnDone]
  connect_bd_net -net cycle_counter [get_bd_pins system_ila_0/probe5] [get_bd_pins test_module_0/cycle_counter]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets cycle_counter]
  connect_bd_net -net pulse_init [get_bd_pins system_ila_0/probe4] [get_bd_pins test_module_0/pulse_init]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets pulse_init]
  connect_bd_net -net rst_ps8_0_100M_peripheral_aresetn [get_bd_pins MI_memoryInterface_A_0/M_AXI_ARESETN] [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins rst_ps8_0_100M/peripheral_aresetn] [get_bd_pins system_ila_0/probe1] [get_bd_pins system_ila_0/resetn] [get_bd_pins test_module_0/rst]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets rst_ps8_0_100M_peripheral_aresetn]
  connect_bd_net -net test_module_0_o_initreadtxn [get_bd_pins MI_memoryInterface_A_0/i_MI_initReadTxn] [get_bd_pins system_ila_0/probe2] [get_bd_pins test_module_0/o_initreadtxn]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets test_module_0_o_initreadtxn]
  connect_bd_net -net test_module_0_o_initwritetxn [get_bd_pins MI_memoryInterface_A_0/i_MI_initWriteTxn] [get_bd_pins test_module_0/o_initwritetxn]
  connect_bd_net -net test_module_0_o_led1 [get_bd_ports o_led1] [get_bd_pins test_module_0/o_led1]
  connect_bd_net -net test_module_0_o_led2 [get_bd_ports o_led2] [get_bd_pins test_module_0/o_led2]
  connect_bd_net -net test_module_0_o_led3 [get_bd_ports o_led3] [get_bd_pins test_module_0/o_led3]
  connect_bd_net -net test_module_0_o_led4 [get_bd_ports o_led4] [get_bd_pins test_module_0/o_led4]
  connect_bd_net -net test_module_0_o_readAdress [get_bd_pins MI_memoryInterface_A_0/i_MU_readAddress] [get_bd_pins test_module_0/o_readAdress]
  connect_bd_net -net test_module_0_o_write_address [get_bd_pins MI_memoryInterface_A_0/i_MU_writeAddress] [get_bd_pins test_module_0/o_write_address]
  connect_bd_net -net test_module_0_o_write_payload [get_bd_pins MI_memoryInterface_A_0/i_MU_writePayload] [get_bd_pins test_module_0/o_write_payload]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins MI_memoryInterface_A_0/M_AXI_ACLK] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins rst_ps8_0_100M/slowest_sync_clk] [get_bd_pins system_ila_0/clk] [get_bd_pins test_module_0/clk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins zynq_ultra_ps_e_0/saxihp0_fpd_aclk]
  ...
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces MI_memoryInterface_A_0/M_AXI] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_LOW] -force
  assign_bd_address -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces MI_memoryInterface_A_0/M_AXI] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_LPS_OCM] -force
  assign_bd_address -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces MI_memoryInterface_A_0/M_AXI] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_QSPI] -force
